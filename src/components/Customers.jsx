...
const Customers = () => {
    return (
        <section className={'m-auto container flex justify-center items-center px-4 sm:mt-20 lg:mt-40 xl:mt-40 2xl:mt-40'}>
            <div>
                <div className='flex flex-col gap-10 justify-center items-center'>
                    ...
                    <p className={'w-6/12 text-center text-[#848FAC] sm:text-sm lg:w-8/12 text-lg xl:text-xl 2xl:text-xl'}>
