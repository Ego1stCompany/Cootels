...
const Contacts = () => {
    ...
    return (
        <section
            className={'m-auto container grid grid-cols-2 gap-16 items-center mt-40 px-4 sm:mt-20 lg:mt-40 xl:mt-40 2xl:mt-40'}>
            <div className={'flex grow shrink basis-6/12 flex-col gap-8 justify-start'}>
                ...
                <p className={'text-[#848FAC] sm: text-sm lg:text-lg xl:text-lg 2xl:text-lg'}>You
